...
HXLINE(  38)		app->meta->set(HX_("build",2e,db,ea,ba),HX_("586",73,68,28,00));
...
HXLINE(  42)		app->meta->set(HX_("packageName",f1,04,ad,04),HX_("com.sample.helloworld",57,74,ba,b0));
